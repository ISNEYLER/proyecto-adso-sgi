...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-8 border-l-4 border-[#059669] shadow-md mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-emerald-700">Crear Ubicación</h1>
                <p class="text-gray-600 mt-2 flex items-center gap-2">
                    <svg class="w-5 h-5 text-emerald-500" fill="currentColor" viewBox="0 0 24 24"><?= Mdi::mdi('plus-circle'); ?></svg>
                    Agregue una nueva ubicación en almacén
                </p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow p-6 mt-4">
        <form id="formCreateLocation" action="<?= base_url('locations/save') ?>" method="post" autocomplete="off" class="grid grid-cols-1 md:grid-cols-12 gap-4">
            <!-- Almacén -->
