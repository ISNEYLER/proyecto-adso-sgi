...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-8 border-l-4 border-[#3B82F6] shadow-md mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-blue-700">Editar Producto</h1>
                <p class="text-gray-600 mt-2 flex items-center gap-2">
                    <svg class="w-5 h-5 text-blue-500" fill="currentColor" viewBox="0 0 24 24"><?= Mdi::mdi('pencil'); ?></svg>
        ...
        <form id="formCreateProduct"
            ...
            <div class="md:col-span-12">
                ...
                <input type="text"
                       ...
                       class="w-full rounded-xl border-2 px-4 py-3 focus:outline-none transition-all duration-300
                ...
                <?php if(isset($validation) && $validation->hasError('nombre')): ?>
                    <p class="text-sm text-red-600 mt-2 flex items-center gap-1"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><?= Mdi::mdi('alert-circle'); ?></svg>
            ...
            <div class="md:col-span-4">
                ...
                <select name="categoria"
                        class="w-full rounded-xl border-2 px-4 py-3 focus:outline-none transition-all duration-300 bg-white cursor-pointer
            ...
            <div class="md:col-span-12">
                ...
                <textarea name="descripcion"
                          rows="5"
                          class="w-full rounded-xl border-2 px-4 py-3 focus:outline-none transition-all duration-300 resize-none
                          <?= isset($validation) && $validation->hasError('descripcion') 
                                ? 'border-red-500 focus:border-red-600 focus:ring-2 focus:ring-red-200' 
                                : (old('descripcion') ? 'border-green-500 focus:border-green-600 focus:ring-2 focus:ring-green-200' : 'border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200') ?>"><?= $product->descripcion ?></textarea>
