...
<div class="max-w-5xl mx-auto">
    ...
    <div class="flex justify-between items-center p-4">
        <h4 class="text-xl font-semibold text-gray-800">Crear almacen</h4>
    ...
    <div class="bg-white rounded-xl shadow p-6 mt-4">
        <form id="formCreateWarehouse" action="<?= base_url('warehouses/save') ?>" method="post" autocomplete="off" class="grid grid-cols-1 md:grid-cols-12 gap-4">
            <!-- Nombre -->
            <div class="md:col-span-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Nombre</label>
                <input type="text" name="nombre" placeholder="Almacen 1" value="" class="w-full rounded-lg border px-3 py-2 focus:outline-none focus:ring-2
            ...
            <div class="md:col-span-4">
                ...
                <input type="text" name="codigo" placeholder="ALM-1" value="" class="w-full rounded-lg border px-3 py-2 focus:outline-none focus:ring-2
            ...
            <div class="md:col-span-4">
                ...
                <input type="text" name="direccion" placeholder="Almacen 1" value="" class="w-full rounded-lg border px-3 py-2 focus:outline-none focus:ring-2
