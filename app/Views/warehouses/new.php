...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-8 border-l-4 border-[#F97316] shadow-md mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-orange-700">Crear Almacén</h1>
                <p class="text-gray-600 mt-2 flex items-center gap-2">
                    <svg class="w-5 h-5 text-orange-500" fill="currentColor" viewBox="0 0 24 24"><?= Mdi::mdi('plus-circle'); ?></svg>
                    Agregue un nuevo almacén al sistema
                </p>
            </div>
            <div class="flex gap-2">
                <button type="submit" form="formCreateWarehouse"
    ...
    <div class="bg-white rounded-2xl shadow-xl border-t-4 border-orange-500 p-8">
        <form id="formCreateWarehouse" action="<?= base_url('warehouses/save') ?>" method="post" autocomplete="off" class="grid grid-cols-1 md:grid-cols-12 gap-6">
            <!-- Nombre -->
            <div class="md:col-span-4">
                ...
                <input type="text" name="nombre" placeholder="Ej: Almacén Central" value="<?= old('nombre') ?>" class="w-full rounded-xl border-2 px-4 py-3 focus:outline-none transition-all duration-300
            ...
            <div class="md:col-span-4">
                ...
                <input type="text" name="codigo" placeholder="Ej: ALM-001" value="<?= old('codigo') ?>" class="w-full rounded-xl border-2 px-4 py-3 focus:outline-none transition-all duration-300
            ...
            <div class="md:col-span-4">
                ...
                <input type="text" name="direccion" placeholder="Ej: Calle Principal 123" value="<?= old('direccion') ?>" class="w-full rounded-xl border-2 px-4 py-3 focus:outline-none transition-all duration-300
